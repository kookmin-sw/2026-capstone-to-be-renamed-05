...
@interface AccountitAPICPACompanyManagedJobItem : AccountitAPIDTO
...
@property (nonatomic, retain, readonly, nullable) AccountitAPICPAJobSubmissionItem *pendingEditSubmission;
@end

@interface AccountitAPICPACompanyManagedJobListResponse : AccountitAPICollectionResponse

@property (nonatomic, copy, readonly) NSArray<AccountitAPICPACompanyManagedJobItem *> *items;
@end
