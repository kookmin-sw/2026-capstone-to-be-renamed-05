...
@implementation AccountitAPICPACompanyManagedJobItem
...
- (AccountitAPICPAJobSubmissionItem * _Nullable)pendingEditSubmission {
    AccountitAPICPAJobSubmissionItem *DTO = (AccountitAPICPAJobSubmissionItem *)[self DTOForKey:@"pendingEditSubmission" class:[AccountitAPICPAJobSubmissionItem class]];
    return DTO;
}

@end

@implementation AccountitAPICPACompanyManagedJobListResponse

@dynamic items;

+ (Class _Nonnull)itemClass {
    return [AccountitAPICPACompanyManagedJobItem class];
}
